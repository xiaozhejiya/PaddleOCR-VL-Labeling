...
5. doc/开发文档/后端/INDEX.md 中 API、权限和错误码相关路径
```
...
4. doc/开发文档/后端/INDEX.md 中 capabilities、401/403/404/409 和页面资源 API 相关路径
```
...
3. 涉及业务标签展示时读取 doc/开发文档/后端/INDEX.md 中 label_registry / 权限 / API 相关路径
```
...
5. doc/开发文档/k12_annotation_platform_design.md 的 bbox / quad / polygon / read_order 和 QC 章节
6. doc/开发文档/后端/INDEX.md 中 annotation revision、冲突、权限和导出相关路径
```

角色管理前端任务：

```text
1. doc/开发文档/前端/frontend_development_spec.md 的权限与前端安全规范
